...
RUN git describe --tags --dirty > /tmp/sentry-versions/central || echo "unknown" > /tmp/sentry-versions/central
WORKDIR /server
RUN git describe --tags --dirty > /tmp/sentry-versions/server || echo "unknown" > /tmp/sentry-versions/server
WORKDIR /client
RUN git describe --tags --dirty > /tmp/sentry-versions/client || echo "unknown" > /tmp/sentry-versions/client
